# GV Playground - EKS Infrastructure (Mock Version for Planning)
# This creates a production-ready EKS cluster with all necessary components
...
# Elastic IP for NAT Gateway - DISABLED due to EIP limit
...
# NAT Gateway - DISABLED due to EIP limit
...
# Route Table for Private Subnets - Using Internet Gateway instead of NAT Gateway
...
resource "aws_security_group" "eks_node_group" {
  name_prefix = "${var.environment}-eks-node-group-"
  vpc_id      = aws_vpc.main.id
...
resource "aws_s3_bucket" "terraform_state" {
  bucket = "gv-playground-terraform-state"
