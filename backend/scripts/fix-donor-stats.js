// backend/scripts/fix-donor-stats.js
...
async function main() {
  ...
  for (const donor of donors) {
    ...
    const uniqueStudents = new Set(donations.map(d => d.studentId)).size;
    ...
    console.log(`Updated donor ${donor.email}: totalDonated=$${totalDonated}, studentsSupported=${uniqueStudents}`);
  }
